        ...
        <div className="row">
          <div className="col-footer d-flex pt-5">
            <div className="col-3">
              ...
              <div className="text">
                Arcadia è un e-commerce italiano di giochi da tavolo, carte
                collezionabili, cardistry e modellismo. Arcadia è un marchio
                registrato. Ogni utilizzo o riproduzione non espressamente
